        ...
        <div class="row">
            ...
            <div class="col-md-4">
                <div class="activity-user">
                    <ul class="navbar-nav">
                        <li class="nav-item dropdown">
                            <a class="nav-link text-danger" href="#" data-toggle="dropdown"><i class="fas fa-cog"></i> Sizning harakatlaringiz</a>
                            <div class="dropdown-menu">
                                <a class="dropdown-item" href="{{route('user.reviews')}}">Sharxlar</a>
                                <a class="dropdown-item" href="{{route('user.orders')}}">Buyurtmalar</a>
                            </div>
                        </li>
                    </ul>
                </div>
...
<footer class="py-3 text-center border-top bg-light">
    <div class="container">
        ...
        <div class="footer-text">
            Copyright &copy; Barcha huquqlar himoyalangan. <span id="year"></span>
        </div>
