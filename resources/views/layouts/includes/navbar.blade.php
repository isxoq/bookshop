        ...
        <div class="collapse navbar-collapse" id="nav-collapse">
            <ul class="navbar-nav ">
                <li class="nav-item px-2 ">
                    <a href="{{route('bookshop.home')}}" class="nav-link">Bosh sahifa</a>
                </li>
                <li class="nav-item px-2">
                    <a href="{{route('all-books')}}" class="nav-link">Kitoblar</a>
                </li>
                <li class="nav-item px-2">
                    <a href="{{route('discount-books')}}" class="nav-link">Chegirma kitoblar</a>
                </li>
                <li class="nav-item px-2">
                    <a href="#" class="nav-link">Biz haqimizda</a>
                </li>
            </ul>
            <ul class="navbar-nav ml-auto">
                @if(Auth::check() == false)
                    <li class="nav-item px-2">
                        <a href="{{url('login')}}" class="nav-link text-danger"><i class="fas fa-user-lock"></i> Kirish</a>
                    </li>
                    <li class="nav-item">
                        <a href="{{url('register')}}" class="nav-link"><i class="fas fa-user"></i> Ro'yhatdan o'tish</a>
                    </li>
                @else
