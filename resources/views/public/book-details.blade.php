                    ...
                    <div class="content-area">
                        <div class="card my-4">
                            <div class="card-header bg-dark">
                                <h4 class="text-white">Kitob ma'lumotlari</h4>
                            </div>
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="author mb-2">
                                            Avtor <a href="{{route('author', $book->author->slug)}}">{{$book->author->name}}</a>
                                        </div>
                                        @if(($book->quantity) > 1)
                                            <div class="badge badge-success mb-2">Mavjud</div>
                                        @else
                                            <div class="badge badge-danger mb-2">Mavjud emas</div>
                                        @endif
                                        @if($book->discount_rate)
                                            <h6><span class="badge badge-warning">{{$book->discount_rate}}% chegirma</span></h6>
                                        @endif
                                        <div class="book-price mb-2">
                                            <span class="mr-1">Narx - </span>
                                            @if($book->discount_rate)
                                                <span></span><strong class="line-through">${{$book->init_price}}</strong>
                                            @endif
                                                <span>Hozirda - </span><strong>${{$book->price}}</strong>
                                            @if($book->discount_rate)
                                                <div><strong class="text-danger">Saqlaysiz ${{$book->init_price - $book->price}}</strong></div>
                                            @endif
                                        </div>
                                        <div class="book-category mb-2 py-1 d-flex flex-row border-top border-bottom">
                                            ...
                                            <a href="#review-section" class="mr-4"><i class="fas fa-comments"></i> Sharhlar</a>
                                        </div>
                                        ...
                                        <form action="{{route('cart.add')}}" method="post">
                                            ...
                                            <span class="quantity-input mr-2 mb-2">
                                                ...
                                                <button type="submit" class="btn btn-danger btn-sm"><i class="fas fa-shopping-cart"></i> Savatga</button>
                                            </div>
                                        </form>
                                ...
                                <div class="des">
                                    ...
                                    <small>
                                        <a href="{{route('author', $book->author->slug)}}">
                                            ...
                                            Kitoblar - {{ $book->author->books()->count()}} ta
                                        </a>
                                    </small>
